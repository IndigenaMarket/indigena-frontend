...
const ReactS3Client = new S3(config);
 ...
 const Updatecollection=async()=>
 {
  ...
  const result=await axios.put(process.env.REACT_APP_API_URL.toString()+"/updateCollection",{WalletAddress:address.toString().toLowerCase(),
  "LogoImage":logo,
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            <button className="mintNFT_btn" onClick={()=>Updatecollection()} >Update</button>
          </div>
          <div className="col-lg-3"></div>
        </div>
      </div>
