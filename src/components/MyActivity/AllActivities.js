      ...
      >
        ...
        <div className=" row stats_btn_grp">
          ...
          <div className="row">
            ...
            <div className="col-lg-10 col-12 col-md-10 table-responsive" style={{overflow:"auto"}}>
              {data.length != 0 ? (
                <table className="stats_table " style={{minWidth: width < 600 && "900px",textAlign: "center" }}>
                  <thead>
                    <tr>
