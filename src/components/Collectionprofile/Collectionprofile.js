                  ...
                  <div class="profile-block">
                    ...
                    <div className='row profile-responsive' >
                      ...
                      <div className='col-md-4 col-lg-4 col-12' >
                        <div className="row" style={{ justifyContent: width > 600 ? "flex-end" : "center"}} >
                          {profileInfo.FaceBook ? <div className="col-lg-3 col-1">
                            <a href={profileInfo.FaceBook} target='_blank'> <img src={fb} alt='social-fb' className="social-img" /></a>
                          </div> : ""}
                          {profileInfo.Twitter ? <div className="col-lg-3 col-1" >
                            <a href={profileInfo.Twitter} target='_blank' > <img src={twitter} alt='social-fb' className="social-img" /></a>
                          </div> : ""}
                          {profileInfo.Other ? <div className="col-lg-3 col-1">
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-6 ">
                              <div className="profile-details-columns">
                                <div className="asset-key user">
                                  <span>Floor</span>
                                  <div className="asset-value">{isNaN(colectionfloor)?"0": colectionfloor != 0 ? colectionfloor : "0"}</div>
                                </div>
            ...
            <div className='container'>
              <div className='row'>
                {(nftdata !== [] && collectionenable != true) ? nftdata.map((e, i) =>
                  ...
                  <ViewCard key={i} nft={e} execute={executeorder} width={width}/>
