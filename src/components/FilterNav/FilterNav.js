...
function FilterNav({ showFilter, setShowFilter, execute,width }) {
  ...
  return (
    <div className="container-fluid filter_nav_container2 ">
      <div className="row filterNavRow">
        {
          width > 600 ? <div className="col-sm-1"></div> : null
        }
        
        <div className="col-12 col-md-12 col-lg-12 col-sm-12  filterSearchContainer">
          <div onClick={handleShowFilter} className="filterIcon" height={width < 600 && "30"}>
            ...
            {/* <div class="form-group">
                            ...
                            <select
                              ...
                              id="exampleFormControlSelect1"
                               onChange={(val)=>execute('select',e.target.value)}
                            >
          ...
          <>
            <div className=" container-fluid filterOtpions_container">
              ...
              <div
                ...
                className={
                  firstDropDown
                    ? "row dropdownRow statusdropDown_active"
                    : "row dropdownRow statusdropDown"
                }
              >
                <div className="col-2 icon">
                  <AnalyticsIcon />
                </div>
                <div className="col-8 text my-2" >Status</div>
              ...
              >
                ...
                <div className="col-8 text my-2">Price</div>
                <div className="col-2 downIcon">
                  <KeyboardArrowDownIcon />
                </div>
              </div>
              ...
              <div
                ...
                className={
                  thirdDropDown
                    ? "row dropdownRow filedropDown_active mb-3"
                    : "row dropdownRow filedropDown mb-3"
                }
              >
                <div className="col-2 icon">
                  <GridViewIcon />
                </div>
                <div className="col-8 text my-2 ">Files Type</div>
                <div className="col-2 downIcon">
                  <KeyboardArrowDownIcon />
                </div>
              </div>
